...
class FlatbuttonInfo extends StatelessWidget {
  ...
  FlatbuttonInfo({this.onPressed, this.text='',this.width,this.textHeight,this.alignment=Alignment.center,this.sizeBoxWidth});
